...
const FloatingSupport = () => {
  ...
  return (
    <div className="fixed bottom-10 right-10 z-[100] flex flex-col items-end gap-6">
        ...
        <div className="bg-[#ecf0f3] dark:bg-[#151E32] rounded-[3rem] p-8 shadow-[20px_20px_60px_#cbced1,-20px_-20px_60px_#ffffff] dark:shadow-[20px_20px_60px_#0a0f1d] border border-white/40 mb-4 animate-in slide-in-from-bottom-10 fade-in duration-500 w-80">
          ...
          <div className="space-y-4">
             ...
             >
                ...
                <div className="text-left">
                   <p className="text-[0.95rem] font-black text-slate-800 dark:text-white">WhatsApp Sync</p>
                   <p className="text-[0.7rem] font-bold text-slate-400 uppercase tracking-widest">Instant Clinical Chat</p>
                </div>
             </button>
             ...
             >
                ...
                <div className="text-left">
                   <p className="text-[0.95rem] font-black text-slate-800 dark:text-white">Voice Uplink</p>
                   <p className="text-[0.7rem] font-bold text-slate-400 uppercase tracking-widest">Priority Doctor Call</p>
                </div>
             </button>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-slate-200/50 dark:border-white/5">
             <div className="flex items-center justify-between text-[0.65rem] font-black text-slate-400 uppercase tracking-[0.2em]">
                <span className="flex items-center gap-2"><Activity size={12} className="text-[#2ECC71]" /> Link Active</span>
                <span>Encrypted</span>
             </div>
          </div>
        </div>
      ...
      >
        {isOpen ? <X size={32} className="text-white" /> : <Zap size={32} className="text-white fill-white" />}
