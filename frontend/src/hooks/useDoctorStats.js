  ...
  const refreshStats = useCallback(async () => {
    try {
      ...
      if (activity.length === 0) {
        activity = [
          { id: 'act1', patient: 'Sarah Connor', detail: 'MRI Scan results transmitted', time: '2 hrs ago', isCritical: false },
          { id: 'act2', patient: 'James Wilson', detail: 'High BP Alert: 160/95 mmHg', time: '5 hrs ago', isCritical: true },
          { id: 'act3', patient: 'John Doe', detail: 'Prescription refill requested', time: 'Yesterday', isCritical: false },
          { id: 'act4', patient: 'James Wilson', detail: 'Lipid Profile uploaded', time: '2 days ago', isCritical: false }
        ];
      }
      ...
      setCriticalCases(critical.length > 0 ? critical : [
        { id: 'mock1', name: 'James Wilson', condition: 'Hypertension Review', status: 'Scheduled' }
      ]);
