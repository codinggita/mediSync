...
import { Building2, Search, Filter, MoreHorizontal, CheckCircle, XCircle, Clock } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className={`text-[2.5rem] font-black leading-none ${isDarkMode ? 'text-white' : 'text-[#1F2937]'}`}>
            Pharmacy <span className="text-[#2ECC71]">Nexus</span>
          </h1>
          <p className="text-slate-500 text-sm mt-3 font-bold uppercase tracking-wider opacity-80">Verification & Global Network Management</p>
        </div>
      ...
      <div className={`rounded-[3.5rem] overflow-hidden bg-[#ecf0f3] dark:bg-[#151E32] shadow-[20px_20px_40px_#cbced1,-20px_-20px_40px_#ffffff] dark:shadow-[20px_20px_40px_#0a0f1d,-20px_-20px_40px_#202d47] border border-white/40 dark:border-white/5 transition-all`}>
