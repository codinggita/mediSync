    ...
    <div className="bg-red-500 rounded-[4rem] p-12 text-white shadow-[0_20px_50px_rgba(239,68,68,0.4)] relative overflow-hidden group">
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-4 mb-8">
           ...
           <div>
              <h2 className="text-[2.2rem] font-black tracking-tighter uppercase leading-none">Critical Response</h2>
              <p className="text-[0.9rem] font-bold opacity-80 mt-1 uppercase tracking-widest">Immediate Tactical Activation</p>
           </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
           <button className="bg-white text-red-500 p-8 rounded-[3rem] flex flex-col items-center gap-4 hover:scale-105 active:scale-95 transition-all shadow-xl group/btn">
              ...
              <p className="text-[0.7rem] font-bold opacity-60 uppercase tracking-widest">Connect to 102/108</p>
           </button>
           <button className="bg-red-600 text-white p-8 rounded-[3rem] flex flex-col items-center gap-4 hover:scale-105 active:scale-95 transition-all shadow-xl border border-white/20 group/btn">
              ...
              <p className="text-[0.7rem] font-bold opacity-60 uppercase tracking-widest">Reroute Navigation</p>
           </button>
        </div>
        ...
        <div className="mt-10 p-6 bg-black/10 rounded-[2.5rem] border border-white/10 flex items-center justify-between">
           <div className="flex items-center gap-4">
              ...
              <span className="text-[0.9rem] font-black uppercase tracking-widest">Secured Bio-ID Broadcast Active</span>
           </div>
           <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-white animate-ping" />
              <span className="text-[0.7rem] font-black opacity-80 uppercase tracking-tighter">Live Sync</span>
           </div>
        </div>
      </div>
    </div>
