  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="relative group">
         <Mail className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-[#2A7FFF] transition-colors" size={20} />
         <input 
           type="email" 
           value={email}
      ...
      >
         {isLoading ? <><Loader2 className="animate-spin" size={20} /> Initializing Sync...</> : 'Send Reset Protocol'}
      </button>
    </form>
  );
};
