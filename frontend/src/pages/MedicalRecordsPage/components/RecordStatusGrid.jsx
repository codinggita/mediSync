  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="bg-[#ecf0f3] dark:bg-[#151E32] rounded-[2.5rem] p-7 shadow-[8px_8px_16px_#cbced1,-8px_-8px_16px_#ffffff] dark:shadow-[8px_8px_16px_#0a0f1d,-8px_-8px_16px_#202d47] flex items-center gap-5">
        <div className={`w-14 h-14 rounded-2xl flex items-center justify-center ${hasAlert ? 'bg-amber-500/10 text-amber-500' : 'bg-emerald-500/10 text-emerald-500'} shadow-inner`}>
        ...
        <div>
          ...
          <h4 className={`text-[1.1rem] font-black ${hasAlert ? 'text-amber-600' : 'text-emerald-600'}`}>
