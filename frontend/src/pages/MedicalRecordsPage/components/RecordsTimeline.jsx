...
const RecordsTimeline = ({ records, selectedId, onSelect }) => {
  ...
  const getColor = (type) => {
    switch (type?.toLowerCase()) {
      ...
      case 'radiology': return '#2A7FFF';
      case 'cardiology': return '#2ECC71';
        ...
        {records.length > 0 ? records.map((rec, i) => (
          ...
          />
            ...
            <div className="flex flex-col items-center justify-center py-20 opacity-40">
              ...
              <p className="text-[0.8rem] font-black text-slate-400 uppercase tracking-widest">No artifacts detected</p>
            </div>
        )}
      </div>
    </div>
