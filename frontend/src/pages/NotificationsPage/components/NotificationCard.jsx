        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-3">
              <h3 className="text-[1rem] font-black text-slate-900 dark:text-white">
                {notif.title}
              </h3>
              {!notif.read && (
                <div className="w-2 h-2 rounded-full bg-[#2A7FFF] animate-pulse"></div>
              )}
            </div>
          ...
          <p className="text-[0.9rem] font-medium text-slate-500 dark:text-slate-400 leading-relaxed mb-4">
            {notif.message}
          </p>
