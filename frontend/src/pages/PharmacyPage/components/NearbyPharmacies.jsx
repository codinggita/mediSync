...
const PHARMACIES = [
  { id: 1, name: 'MedPlus Intelligence', distance: '1.2 km', rating: 4.8, status: 'Open Now', phone: '+919876543210', location: 'Medical District, North Block' },
  { id: 2, name: 'Apollo Pharmacy Hub', distance: '2.4 km', rating: 4.5, status: 'Open 24/7', phone: '+919876543211', location: 'Health Avenue, Sector 4' },
  { id: 3, name: 'Wellness Forever', distance: '3.1 km', rating: 4.2, status: 'Open Now', phone: '+919876543212', location: 'Wellness Plaza, East Wing' },
];
        ...
        {PHARMACIES.map((p) => (
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-[0.65rem] font-black bg-emerald-500/10 text-emerald-500 px-4 py-1.5 rounded-full uppercase tracking-widest border border-emerald-500/20">{p.status}</span>
            </div>

            <h3 className="text-[1.25rem] font-black text-slate-900 dark:text-white mb-2 leading-tight">{p.name}</h3>
