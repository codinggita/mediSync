...
const SharingPage = () => {
  ...
  const {
    doctors, records, loading, sharingRecord, setSharingRecord,
    selectedDoctor, selectedRecordId, setSelectedRecordId,
    isSharing, successMessage, handleShareClick, handleConfirmShare
  } = useSharing(user);
