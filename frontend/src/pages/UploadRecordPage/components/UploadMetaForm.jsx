...
const categories = [
  'Lab Report', 'Prescription', 'X-Ray / Scan', 'ECG Report',
...
const UploadMetaForm = ({ file, onSubmit, onCancel }) => {
  ...
  const labelCls = 'flex items-center gap-2 text-[0.7rem] font-black text-slate-400 dark:text-slate-500 mb-2 uppercase tracking-widest';

  return (
    <form onSubmit={handleSubmit} className="bg-[#ecf0f3] dark:bg-[#151E32] rounded-[3rem] p-8 shadow-[15px_15px_30px_#cbced1,-15px_-15px_30px_#ffffff] dark:shadow-[15px_15px_30px_#0a0f1d,-15px_-15px_30px_#202d47] transition-all relative overflow-hidden">
